(function($) {
    ...
    function generate_youtube(config) {
        ...
        var code = '<object width="' + config.width + '" height="'+ config.height + '"><param name="movie" value="http://www.youtube.com/v/' + config.video_id + '?fs=1&amp;hl=en_US"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="http://www.youtube.com/v/' + config.video_id + '?fs=1&amp;hl=es_ES" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="' + config.width + '" height="'+ config.height + '" wmode="transparent"></embed></object>'
        return code;
    }
